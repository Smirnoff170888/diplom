...
export default class Api {
    /**
     * @param {String} baseUrl базовый URL, от которого будут расти относительные пути запросов
    ...
    /**
     * Обработчик ошибки, проверяет, если зарегистрирован onError cb, то вызывает его, иначе пишет ошибку в консоль
